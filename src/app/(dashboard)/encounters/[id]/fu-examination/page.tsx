...
export default function FuExaminationPage() {
  ...
  return (
    <div className="max-w-3xl">
      <div className="mb-6">
        <h2 className="text-xl font-bold">Focused Clinical Examination</h2>
        ...
        {(form) => {
          ...
          return (
            <div className="space-y-6">
              <div>
                <h3 className="text-sm font-semibold mb-3">General Observations</h3>
              ...
              <div>
                <h3 className="text-sm font-semibold mb-3">Neurological Examination</h3>
                <ToggleField
              ...
              <div>
                <h3 className="text-sm font-semibold mb-3">Diagnosis-Specific Findings</h3>
